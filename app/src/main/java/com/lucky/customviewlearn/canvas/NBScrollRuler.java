...
public class NBScrollRuler extends View {
    ...
    public NBScrollRuler(Context context) {
        this(context, null);
    }

    public NBScrollRuler(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NBScrollRuler(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
