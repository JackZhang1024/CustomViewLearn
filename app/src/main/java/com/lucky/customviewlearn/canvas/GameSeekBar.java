...
public class GameSeekBar extends View {
    ...
    public GameSeekBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
    ...
    private void init() {
        ...
        Timber.e("width "+mDisplayMetrics.widthPixels +" height "+mDisplayMetrics.heightPixels);
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        // srcRect表示的要显示的Bitmap的大小
        // destRect表示的要显示的Bitmap的位置
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int index = 0; index < mTextCount; index++) {
            ...
            mTextViewTop = mDestRect.top - textHeight;
