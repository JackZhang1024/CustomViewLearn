...
// TODO: 2020-03-27 这个类有上拉和下拉加载问题  注意看第179行解释
public class SimpleRefreshTwoLayoutOld extends ViewGroup {
    ...
    public SimpleRefreshTwoLayoutOld(Context context) {
        super(context);
    }

    public SimpleRefreshTwoLayoutOld(Context context, AttributeSet attrs) {
        super(context, attrs);
                ...
                if (childMiddle != null) {
                    if (childMiddle instanceof ListView) {
                        ...
                        if (scrollView.getScrollY() <= 0) {
                            ...
                            intercept = true;
                        } else if (scrollView.getScrollY() + scrollView.getHeight() >= childInScrollView.getHeight()) {
                            // 判断是否已经到最底部了
